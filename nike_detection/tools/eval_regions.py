"""Evaluate region detection against the synthetic catalog.
  ...
  python -m nike_detection.tools.eval_regions
  python -m nike_detection.tools.eval_regions --full
"""
...
from nike_detection.config.schema import AppConfig, RegionReference
