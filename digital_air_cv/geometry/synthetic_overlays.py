...
from digital_air_cv.config.schema import RegionReference
from digital_air_cv.geometry.region_metrics import corners_from_xyxy
from digital_air_cv.io.image_loader import Scan
