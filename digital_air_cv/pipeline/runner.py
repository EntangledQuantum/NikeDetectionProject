...
from digital_air_cv.config.loader import load_regions_file
from digital_air_cv.config.schema import RegionSpec, RunSettings
from digital_air_cv.geometry.full_region_detector import (
    color_prefix_from_path,
    detect_full_regions,
    draw_corner_montage,
    draw_region_overlay,
)
from digital_air_cv.io.defect_summary import write_defect_summary
from digital_air_cv.io.image_loader import MEMMAP_MIN_BYTES, Scan, load_bgr_gray, open_scan
from digital_air_cv.io.region_views import slice_view
from digital_air_cv.io.results import save_image_result, save_summary_report
from digital_air_cv.io.visualization import (
    draw_full_defect_overlay,
    save_debug,
    save_visualization,
)
from digital_air_cv.pipeline.context import ImageContext
from digital_air_cv.pipeline.preprocess_island import GeometryError
from digital_air_cv.pipeline.registry import (
    ALL_DETECTOR_KEYS,
    create_detectors,
    filter_keys,
    keys_for_type,
)
from digital_air_cv.pipeline.types import (
    DetectionResult,
    ImageResult,
    ImageType,
    classify_image,
